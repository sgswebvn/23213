...
if (checklogin2()==false){  header('Location: index.php'); exit(); }
        ...
        <aside class="Modal-box">
            <header class="UserModal-header">
                ...
                <div class="UserModal-thumb">
                    <img src="./admin/<?php echo $_SESSION['profile_image'];?>" alt="" />
                </div>
            ...
            <section class="UserModal-info">
                ...
                <a href="index.php" class="thea"> TRANG NGƯỜI DÙNG</a>
                ...
                <a href="./admin/logout.php" class="thea"> ĐĂNG XUẤT </a>
            </section>
        </aside>
    </div>
    <!-- partial -->
